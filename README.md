...
This repository contains a custom OpenTelemetry Java extension designed to offer backward compatibility for the Dubbo 2.5.x framework. It enables key OpenTelemetry capabilities such as distributed tracing capture for Dubbo 2.5.x.
...
\`\`\`bash
-javaagent:/path/to/splunk-otel-javaagent.jar -Dotel.javaagent.extensions=/path/to/custom-java-ext-dubbo2_5-1.0-all.jar
\`\`\`
